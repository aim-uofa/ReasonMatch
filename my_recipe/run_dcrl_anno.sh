#!/usr/bin/env bash
set -euxo pipefail
# DCRL training recipe: GRPO advantage estimator with GSPO policy-loss mode.

project_name='reasonmatch_dcrl'
exp_name='DCRL-GRPO-GSPO'

dataset_name=MultiRawDataset
# 'AnnoRawDataset'
# dataset_name='DL3DV'
